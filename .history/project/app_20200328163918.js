...
//STRINGS 
const middleName = 'William'lawssons;
...
value = 'Hello, my name is ' + middleName + ' and I am ' + age; // in ES6 they introduced template literals/strings which makes this easier
...
//Methods
//Length
value = middleName.length;

//concat method
value = middleName.concat(' ', lastName);

//change Case
value = middleName.toLowerCase();
